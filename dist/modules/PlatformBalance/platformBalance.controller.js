...
const initializePlatformBalance = (0, catchAsync_1.default)(async (req, res) => {
    const result = await platformBalance_service_1.PlatformBalanceServices.initializePlatformBalanceIntoDB(req.body);
...
const getAllPlatformBalances = (0, catchAsync_1.default)(async (req, res) => {
    const result = await platformBalance_service_1.PlatformBalanceServices.getAllPlatformBalancesFromDB();
    (0, sendResponse_1.default)(res, {
...
const updatePlatformBalance = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const result = await platformBalance_service_1.PlatformBalanceServices.updatePlatformBalanceInDB(id, balance);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
...
const resetPlatformBalance = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const result = await platformBalance_service_1.PlatformBalanceServices.resetPlatformBalanceByName(platformName, balance);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
...
const resetAllPlatformBalances = (0, catchAsync_1.default)(async (req, res) => {
    const result = await platformBalance_service_1.PlatformBalanceServices.resetAllBalancesFromDB();
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
